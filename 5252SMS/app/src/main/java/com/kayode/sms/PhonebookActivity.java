...
public class PhonebookActivity extends Activity {SimpleCursorAdapter mAdapter;
...
public void onCreate(Bundle savedInstanceState) {
    ...
    mAdapter = new SimpleCursorAdapter(getBaseContext(),
            R.layout.phonebooklay,
            null,
            new String[] { "name"},
            new int[] { R.id.detail1}, 0);
    
    // Getting reference to listview
    ListView lstContacts = (ListView) findViewById(R.id.phonebook);
